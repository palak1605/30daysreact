...
const handleColorChange=(i)=>{
    ...
    return(
        ...
        <button onClick={()=>handleColorChange(0)} style={{backgroundColor:'red',color:'white'}}>Red</button>
        <button onClick={()=>handleColorChange(1)} style={{backgroundColor:'yellow'}}>Yellow</button>
        <button onClick={()=>handleColorChange(2)} style={{backgroundColor:'green',color:'white'}}>Green</button>
        </div>
        <button onClick={()=>setIsAutomatic(true)}>Automatic On</button>
        <div className="circle" style={{backgroundColor: colorList[color]}}>
        </div>
        </>
    )
